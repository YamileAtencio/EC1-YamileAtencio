...
import com.idat.EvaC.service.ProfesorService;
...
public class ProfesorController {
	...
	public ResponseEntity<List<Profesor>> listar(){//INTERACTUA CON HTTP
	...
	public ResponseEntity<Profesor> obtenerPorId(@PathVariable Integer id){
		...
		Profesor profesor = service.obtener(id);//VALIDO QUE EXISTA
		if(profesor != null) {
	...
	public ResponseEntity<Void> editar(@RequestBody Profesor profesor){
		...
		Profesor p = service.obtener(profesor.getIdProfesor());//VALIDO QUE EXISTA
		if(p != null) {
